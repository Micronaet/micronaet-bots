...
recorddefs = {
    ...
    'TMA': [
        ...
        ['IMPONIB1', 'C', (16, 16), 'AN'], # +12.3
        ['TOTRIGHE1', 'C', (16, 16), 'AN'], # +12.3
        ['TOTANT1', 'C', (16, 16), 'AN'], # +12.3
        ['TOTPAG1', 'C', (16, 16), 'AN'], # +12.3
        ['DIVISA1', 'C', (3, 3), 'AN'],

        ['TOTDOC2', 'M', (16, 16), 'AN'], # +12.3
        ['IMPOSTA2', 'M', (16, 16), 'AN'], # +12.3
        ['IMPONIB2', 'C', (16, 16), 'AN'], # +12.3
        ['TOTRIGHE2', 'C', (16, 16), 'AN'], # +12.3
        ['TOTANT2', 'C', (16, 16), 'AN'], # +12.3
        ['TOTPAG2', 'C', (16, 16), 'AN'], # +12.3
        ['DIVISA2', 'C', (3, 3), 'AN'],

        ['TOTMERCE', 'C', (16, 16), 'AN'], # +12.3
        ['TOTRITACC', 'C', (16, 16), 'AN'], # +12.3
        ],
