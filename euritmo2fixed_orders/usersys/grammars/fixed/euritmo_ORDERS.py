...
recorddefs = {
    ...
    # -------------------------------------------------------------------------
    # NOTE:
    # Il Segmento RFF e' facoltativo nell'Ordine ed e' obbligatorio nella
    # Conferma
    ...
    # DATAORDC, perch su questi due campi si effettua l'abbinamento con il
    # relativo Ordine.
    ...
    # -------------------------------------------------------------------------
    # NOTA:
    # Il Segmento RFC e' facoltativo nel documento Ordine, e non e' da
